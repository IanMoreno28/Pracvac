...
class KidsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post kids_url, params: { kid: { Fecha_nac: @kid.Fecha_nac, apellido: @kid.apellido, dni: @kid.dni, nombre: @kid.nombre, sexo: @kid.sexo } }
    end
  ...
  test "should update kid" do
    patch kid_url(@kid), params: { kid: { Fecha_nac: @kid.Fecha_nac, apellido: @kid.apellido, dni: @kid.dni, nombre: @kid.nombre, sexo: @kid.sexo } }
