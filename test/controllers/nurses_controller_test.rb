...
class NursesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nurse" do
    assert_difference('Nurse.count') do
      post nurses_url, params: { nurse: { apellido: @nurse.apellido, nombre: @nurse.nombre, user_id: @nurse.user_id } }
    end
  ...
  test "should update nurse" do
    patch nurse_url(@nurse), params: { nurse: { apellido: @nurse.apellido, nombre: @nurse.nombre, user_id: @nurse.user_id } }
